...
-- Reporting must contain no client-markup fields or parallel net/client values.
...
comment on view public.v_ad_stats_reporting is
  'Daily reporting layer with views, clicks, video opens, net spend, budget, and period. No markup fields are exposed.';
