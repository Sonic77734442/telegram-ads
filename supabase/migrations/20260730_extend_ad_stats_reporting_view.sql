...
select
  ...
  coalesce(cb.markup_percent, 0)::numeric as markup_percent
...
comment on view public.v_ad_stats_reporting is
  'Daily reporting layer over ad_stats with video opens, net/client spend, net/client budget, and period fields.';
